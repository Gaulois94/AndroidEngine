...
{
	public:
		DynamicAnim(Updatable* parent, Material* mtl, const Texture* texture, const std::vector<Rectangle2ui*>& animRect, void* info, uint32_t currentN, uint32_t nbFrames, uint32_t posX, uint32_t posY);
